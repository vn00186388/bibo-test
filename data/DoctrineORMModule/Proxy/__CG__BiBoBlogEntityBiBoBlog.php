...
namespace DoctrineORMModule\Proxy\__CG__\BiBoBlog\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class BiBoBlog extends \BiBoBlog\Entity\BiBoBlog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'slug', 'content', 'createdAt', 'updatedAt', 'user', 'comments', 'inputFilter');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BiBoBlog $proxy) {
